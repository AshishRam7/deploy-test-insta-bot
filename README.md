...
2. **Navigate to Products** → **Add Products** → Subscribe to **Instagram**.
   <img width="923" alt="image" src="https://github.com/user-attachments/assets/07922c9f-1166-49e2-afb6-1b55c40f4510" />

3. Click **API Setup with Instagram Login** on the sidepanel under **Products -> Instagram**.
...
6. Set the Webhook URL in Instagram  as `https://<public_deployed_url>/webhook` and use the verification token you had setup in `Environment variables`.
   ![image](https://github.com/user-attachments/assets/9bd7d6a1-e0fe-40f5-9b22-fa723b505e07)

7. Make the App live before the next verification step.
    <img width="866" alt="image" src="https://github.com/user-attachments/assets/a085ce24-7ef0-420d-a29f-bc994f4e3c40" />

8. Toggle the **add certificate** option and then click **Verify Webhook Server** to verify your server and start receiving your webhook notifications.
    ![image](https://github.com/user-attachments/assets/70602b8b-1160-4504-9ad7-64dd691e621f)

9. Subscribe to **comments, live_comments** and the **messages** webhook_fields.
